...
By using the App, you acknowledge that you have read, understood, and agree to these Terms and our Privacy Policy. Continued use constitutes acceptance of all updates to these Terms.
...
1. Use the App for its intended purpose: managing subscriptions and analyzing spending.  
2. Not attempt to reverse engineer, modify, or distribute the App.  
3. Not misuse the App in any way that could damage or disrupt services.  
4. Not attempt to access data that belongs to other users (if any future sharing functionality is added).  
...
- Termination does not affect obligations under these Terms or liability for prior misuse.
